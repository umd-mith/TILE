...
HW={
	start:function(engine){
		...
		el.elem.live('click',function(e){
			...
			$("#azcontentarea").append('<div class="az inner helloworld"><div class="header"><div class="menuitem"><a id="deleteHello">Delete TILE Object</a></div><div class="menuitem"><a id="generateHello">Create TILE Object</a></div></div><div class="body"><p id="attachHelloHere" style="helloworld inner">Hello!</p></div></div></div>');
