...
(function ($, R, _) {
	...
	var Trans={
		...
		inputData:function(data){
			...
			if(__v) console.log("putting data.ref: "+data.ref.id+"  into data.obj: "+data.obj.id+"  in transcript");
		...
		bundleData:function(json){
			...
			// 					for(var ref in cL[x]){
			// 						if(!json[url].lines[n][cL[x][ref].type]) json[url].lines[n][cL[x][ref].type]=[];
			// 						json[url].lines[n][cL[x][ref].type].push(cL[x][ref]);
			// 					}
			// 					n++;
			// 									
			// 				}
