...
(function ($, R, _) {
	...
	function Transcript(args){
		...
		if(this.lineArray){
			for(url in this.lineArray){
				...
				// if(console) console.log("lines present in self.manifest["+url+"]: "+self.manifest[url]);
	...
	$.extend(Transcript.prototype, {
		...
		_drawText: function(){
			var self=this;
			if(console) console.log("drawText: "+self.lineArray);
		...
		_addLinkHandle:function(ref){
			...
			if(console) console.log("Transcript addLinkhandle"+ref);
			// deactivate self
			// $(".line_selected").removeClass("line_selected");
		...
		_lineSelected:function(index){
			var self=this;
		 	if(console) console.log("reached _lineSelected with: "+$(".line_selected").attr('id'));
	...
	var Trans={
		...
		_trnsClickHandle:function(e,id){
			var self=e.data.obj;
			if(console) console.log("trnsClickHandle called with: "+id);
