	...
	var TileLogGroup=LogItem.extend({
		...
		addItem:function(e,o){
			...
			if($("#"+$(this).attr('id')+" > #"+m.attr('id')).length){
				...
				var x=m.clone().css("top","0px").appendTo($(this));
				$("#"+x.attr('id')+" > div.tagmenu > div.menuitem > span.btnIconLarge.hand").hide();
				$("#"+x.attr('id')+" > div.tagmenu > #ddown").hide(); 
		...
		pushItem:function(item){
			...
			if($("#"+this.DOM.attr('id')+" > #"+item.attr('id')).length){
				...
				var x=item.clone().css("top","0px").attr("id",item.attr('id')+"copy");
				x.appendTo(this.DOM);
				$("#"+x.attr('id')+" > div.tagmenu > div.menuitem > span.btnIconLarge.hand").hide();
				$("#"+x.attr('id')+" > div.tagmenu > #ddown").hide();
			}
	...
	**/
	var TileTranscriptTag=LogItem.extend({
		init:function(args){
			...
			//get elements
			this.transName=$("#"+this.DOM.attr('id')+" > div.tagname > p.transname");
