	...
	**/
	...
	var TileLogShape=LogItem.extend({
		init:function(args){
			...
			this.editSelectB=$("#"+this.DOM.attr('id')+" > div.tagmenu > #ddown > div.menuitem.ddown > span");
			this.editSelect=$("#"+this.DOM.attr('id')+" > div.tagmenu > #ddown > div.menuitem.ddown > select").attr("id","ddown"+this.uid);
	...
	**/
	var TileTranscriptTag=LogItem.extend({
		init:function(args){
			...
			this.menuSelectB=$("#"+this.DOM.attr('id')+" > div.tagmenu > #ddown > div.menuitem > span");
			this.menuSelect=$("#"+this.DOM.attr('id')+" > div.tagmenu > #ddown > div.menuitem > select").attr("id","ddown_"+this.uid);
