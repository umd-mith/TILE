				...
				if(obj[o]&&(typeof obj[o]=='object')){
					if(obj[o]["id"]){
						...
						if(obj[o]["id"].substring(0,1)=="D"){
							stg+="<li class=\"infoItem\"><br/><span id=\"approve"+obj[o]["id"]+"\" class=\"approveKey button\">APPROVE</span><br/><span id=\"delete'+self.uid+'\" class=\"deleteKey button\">DELETE</span>"+self.getObjData(obj[o])+"<br/></li>";
						} else {
							stg+="<li class=\"infoItem\"><br/><span id=\"delete"+obj[o]["id"]+"\" class=\"deleteKey button\">DELETE</span>"+self.getObjData(obj[o])+"<br/></li>";
						}				
					} else {
