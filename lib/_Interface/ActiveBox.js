...
(function($){
	...
	function ActiveBox(args){
		var self=this;
		self.loc=args.loc;
		self.html=$("<div class=\"az inner\"><span id=\"activeBox_min\">minButton</span><ul id=\"addInfoArea\" class=\"infoItem\"></ul></div>");
				...
				if(obj[o]&&(typeof obj[o]=='object')){
					if(obj[o]["id"]){
						...
						if(obj[o]["id"].substring(0,1)=="D"){
							stg+="<li class=\"infoItem\"><span id=\"minInfo\" class=\"infoItemMin open\">minbutton</span><br/><span id=\"approve"+obj[o]["id"]+"\" class=\"approveKey button\">APPROVE</span><br/><span id=\"delete"+obj[o]["id"]+"\" class=\"deleteKey button\">DELETE</span><br/>"+self.getObjData(obj[o])+"</li>";
						} else {
							stg+="<li class=\"infoItem\"><span id=\"minInfo\" class=\"infoItemMin open\">minbutton</span><br/><span id=\"delete"+obj[o]["id"]+"\" class=\"deleteKey button\">DELETE</span><br/>"+self.getObjData(obj[o])+"</li>";
						}				
					} else {
