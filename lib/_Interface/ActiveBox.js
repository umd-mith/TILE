			...
			for(o in obj){
				...
				if(obj[o]&&(typeof obj[o]=='object')){
					...
					if(/<([A-Za-z][A-Za-z0-9]*)/.test(obj[o])){
						...
						// temp line
						stg+="<li class=\"infoItem\"><span id=\"minInfo\" class=\"infoItemMin btnIconLarge open\"></span><br/><span id=\"approve"+obj[o]+"\" class=\"approveKey button\">APPROVE</span><br/><span id=\"delete"+obj[o]+"\" class=\"deleteKey button\">DELETE</span></li>";				
					} else if(/_/.test(obj[o])){
