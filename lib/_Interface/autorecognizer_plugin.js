	...
	**/
	var TileOCR=Monomyth.Class.extend({
		...
		_closeOutAR:function(){
			...
			var t=self.DOM.position().top;
			self.DOM.parent().animate({opacity:0.25,top:'-=1000'},400,function(e){
				self.DOM.hide();
				self.DOM.css({opacity:1,top:t});
			});
		...
		**/
		...
		_recognize:function(){
			...
			if(!self.regionList[self.curRegion].done) {
				numOfLines = $(".selLine").length;
