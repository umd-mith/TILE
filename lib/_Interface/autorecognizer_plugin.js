		...
		**/
		...
		_recognize:function(){
			...
			//	self.regionList[self.curRegion].images.push($("#srcImageForCanvas").attr('src'));
				...
				console.log("_REG values: "+left+"  "+rtop+"  "+_REG.width);
				console.log("_REG CORRECT: "+scalecorrectx+"  "+scalecorrecty+"  l: "+(left*scalecorrectx)+" rtop: "+(rtop*scalecorrecty));
				console.log("tbarcorrect: "+tbarcorrect);
	 ...
	 var CanvasImage=TILEImage.extend({
		...
		init: function(args){
			...
			$(window).resize(function(e){
				console.log("resize autorec: "+self.uid);
				if($("#"+self.uid).length){
		...
		setUpCanvas: function(url){
			var self = this;
			console.log("autorec canvas image is loading canvas: "+$("#srcImageForCanvas")[0].src+" "+url);
			$("#srcImageForCanvas").load(function(e){
				...
				console.log("autorec loading the canvas: "+$("#srcImageForCanvas")[0].width+" "+$("#srcImageForCanvas")[0].src);
			...
			var CanvasAutoRecognizer=AutoRecognizer.extend({
				...
				thresholdConversion:function(threshold){
					...
					if(this.Region){
						...
						console.log("conversion threshold: "+threshold);
						...
						console.log("converting: "+this.context);
