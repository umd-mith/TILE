	...
	**/
	var TileOCR=Monomyth.Class.extend({
		...
		_setUp:function(e,jsonhtml){
			...
			r.appendTo($(".vd-container"));
			self.regionBox=r.show();
			...
			self.DOM.trigger("ARStart");
			//CanvasAutoRecognizer
			self.DOM.append("<div class='nextButton' id='captureButton'>Capture</div><div class='prevButton' id='prevButton'>Prev</div><div class='nextButton' id='nextButton'>Next</div><div id='done'>Done</div>" +
