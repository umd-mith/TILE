...
(function($){
	...
	var ImageList=Monomyth.Class.extend({
		...
		show:function(data){
			...
			for (var i=0;i<data.length;i++){
				 $("<li class='imageItem'><a href='#'><span class='imageTitle'>"+data[i].title+"</span> <span class='imgURI'>"+data[i].uri+"</span><\/a></li>").appendTo(".az.inner.textImageList > .list");	
			}
