	...
	**/
	...
	var RaphaelImage=TILEImage.extend({
		...
		_shapeActiveHandle:function(e,id){	
			...
			for(x in self.manifest[url].shapes){
				if(self.manifest[url].shapes[x]&&(self.manifest[url].shapes[x].id==id)){
					...
					$("<div class=\"shpButtonHolder\"><div id=\""+foundID+"\" class=\"button shape\">Delete</div></div>").appendTo($("body"));
		...
		_shapeDrawnHandle:function(e,shpObj){
			...
			$("<div class=\"shpButtonHolder\"><div id=\""+shpObj.id+"\" class=\"button shape\">Delete</div></div>").appendTo($(".vd-container"));
		...
		_addLinkHandle:function(ref){
			...
			$(".shpButtonHolder").append($("<div class=\"button shape\">"+ref.id+"</div><span id=\"delete_"+ref.id+"\" class=\"button shape\">X</span>"));
