	...
	var RaphaelImage=TILEImage.extend({
		...
		setUpCanvas:function(url){
			...
			$("#srcImageForCanvas").load(function(e){
				...
				console.log("vdcontainer:first is : "+$("#srcImageForCanvas")[0].width+"  by "+$("#srcImageForCanvas")[0].height);
		...
		zoomHandle:function(e,n){
			...
			if(self.drawTool&&($("#srcImageForCanvas").width()!=0)){
				...
				console.log("imagetagger scale: "+self._imgScale+"  height: "+$("#srcImageForCanvas").height()+"  src: "+$("#srcImageForCanvas").attr('src'));
