		...
		zoomHandle:function(e,n){
			...
			if(self.drawTool){
				...
				if(n>0){
					...
					$("#srcImageForCanvas").width(parseFloat(1.25*$("#srcImageForCanvas").width()));
					$("#srcImageForCanvas").height(parseFloat(1.25*$("#srcImageForCanvas").height()));
					//self.srcImage.css({"width":$(".vd-container").width()+'px',"height":$(".vd-container").height()+"px"});
					
				} else if(n<0){
					$("#srcImageForCanvas").width(parseFloat(0.75*$("#srcImageForCanvas").width()));
					$("#srcImageForCanvas").height(parseFloat(0.75*$("#srcImageForCanvas").height()));
