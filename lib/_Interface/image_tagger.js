	...
	**/
	...
	var RaphaelImage=Image.extend({
		...
		_loadShapesHandle:function(e,json){
			...
			// 						while(diff<=0){
			// 							json[p].scale((1.25*json[p]._scale),(1.25*json[p]._scale));
			// 							json[p].scale=(1.25*json[p]._scale);
			// 							
			...
			// 					
			// 						while(diff>=0){
			// 							json[p].scale((0.75*json[p]._scale),(1.25*json[p]._scale));
			// 							json[p].scale=(0.75*json[p]._scale);
			// 						
			// 							diff-=0.75;
			// 						}
			// 					}
