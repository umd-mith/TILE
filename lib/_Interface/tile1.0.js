	...
	**/
	...
	$.extend(FloatingDiv.prototype, {
		...
		init: function(myID, labels) {
			...
			'<br />';
			// +
			// '<fieldset><ol class="label_formOL"><li class="label_formLI cloneMe"><span class="label_formLabel">Data already attached: </span><br/><div class="form_attachedList"><div class="button">Dang ol label goes here</div></div></li></ol></fieldset>';
