	...
	PluginController.prototype={
		...
		_toolOutputHandle:function(e,data){
			...
			if(((!self.activeTool)||(self.activeTool.id==data.tool))&&(!data.parentTool)){
				...
				if(__v) console.log("Exception caught. this is the current active tool: "+self.activeTool.id+"  and it is gettin': "+data.type);
			...
			if(self.activeTool.inputData){
				...
				if(__v) console.log("this is the current active tool: "+self.activeTool.id+"  and it is gettin': "+data.type);
