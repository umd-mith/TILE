	...
	**/
	...
	PluginController.prototype={
		...
		_setActiveTool:function(e,id){
			...
			if(console) console.log("setActiveTool activates: "+self.activeTool.id);
		...
		_toolOutputHandle:function(e,data){
			if(console) console.log("tooloutputhandle in tile1.0 reached "+e.data.obj.activeTool);
			var self=e.data.obj;
			if(!self.activeTool){ 
				self.activeTool=self.defaultTool;
				if(console) console.log("tool: "+self.defaultTool.id);
			};
