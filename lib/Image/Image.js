				...
				if(this.dots[i][j]>=0){
					...
					if(dot==0){
						...
						if((this.dots[kl])&&(this.dots[kl][j])){
							...
							if((this.dots[kl][ka])){
								if(sides!=0){
									this.dots[kl][ka]=this.dots[i][j];
									sides++;
								}	else if(this.dots[kl][ka]>=0){
									 this.dots[i][j]=this.dots[kl][ka];
	 								sides++;
	 							}
							}
						}
						if((this.dots[kr])&&(this.dots[kr][j])){
							...
							if((this.dots[kr][ka])){
								if(sides!=0){
									this.dots[kr][ka]=this.dots[i][j];
									sides++;
								}	else if(this.dots[kr][ka]>=0){
									 this.dots[i][j]=this.dots[kr][ka];
	 								sides++;
	 							}
							}
						}
