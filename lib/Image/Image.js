...
var RaphaelImage=Image.extend({
	...
	disable:function(){
		...
		this.DOM.hide();
		$("body").unbind("turnPage");
		$("body").unbind("setCoordRegion");
		$("body").unbind("drawrectangle");
		$("body").unbind("drawellipse");
		$("body").unbind("drawpolygon");
		$("body").unbind("zoom");
	},
	enable:function(){
		this.DOM.show();
