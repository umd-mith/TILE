				...
				if(this.dots[i][j]>=0){
					...
					if(dot==0){
						...
						if(prev==null) {
							...
							if((this.dots[i][kl])&&(this.dots[i][kl]>0)){
								this.dots[i][j]=this.dots[i][kl];
							} else if((this.dots[i][kr])&&(this.dots[i][kr]>0)){
								this.dots[i][j]=this.dots[i][kr];
							} 	else if((this.dots[ka][j])&&(this.dots[ka][j]>0)){
									this.dots[i][j]=this.dots[ka][j];
								}	else if((this.dots[kb][j])&&(this.dots[kb][j]>0)){
