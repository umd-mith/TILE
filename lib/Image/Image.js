 ...
 */
 ...
 var CanvasImage=Image.extend({
	...
	setUpCanvas:function(){
		var nw=(this.imageEl.width*(1000*(Math.pow(2,this.zoomLevel))))/this.imageEl.height;
	...
	zoom:function(e,val){
		...
		if((val>0)&&(obj.zoomLevel<5)){
			//zoom in
			obj.zoomLevel++;
			var w=(obj.imageEl.width*(1000*(Math.pow(2,obj.zoomLevel))))/(obj.imageEl.height);
			var h=(obj.imageEl.height*(1000*(Math.pow(2,obj.zoomLevel))))/(obj.imageEl.width);
			obj.canvasEl.width=(obj.imageEl.width*(Math.pow(2,obj.zoomLevel)));
			obj.canvas.height=(obj.imageEl.height*(Math.pow(2,obj.zoomLevel)));
