...
var RaphaelImage=Image.extend({
	...
	//	$(this.image.node).bind("click",{obj:this},this.imageMouseOver);
	...
	drawRectangle:function(e){
		...
		if(obj.canvasObj){
			if(!obj.rect){
				obj.rect=obj.canvasObj.rect(10,10,100,100);
				obj.rect.attr({stroke:"#FF0000",fill:"#FF0000"});
			
				$("body").bind("move",{obj:obj},function(e,dir,n){
					var obj=e.data.obj;
					var x=(dir=="left")?n:0;
					var y=(dir=="top")?n:0;
					obj.rect.attr("x",(obj.rect.attr("x")+x));
					obj.rect.attr("y",(obj.rect.attr("y")+y));
				});
				$(obj.rect.node).bind("mousedown",{obj:obj},function(e){
					var obj=e.data.obj;
					$(obj.rect.node).bind("mousemove",{obj:obj,shape:obj.rect},obj.moveShape);
				});
				$(obj.rect.node).bind("mouseup",{obj:obj},function(e){
					var obj=e.data.obj;
					$(obj.rect.node).unbind("mousemove",obj.moveShape);
				});
			}
		}
	},
	drawEllipse:function(e){
		var obj=e.data.obj;
		if(obj.canvasObj){
			var ellipse=obj.canvasObj.ellipse(100,200,150,189);
			ellipse.attr({stroke:"#FF0000"});
			ellipse.node.onmousedown=function(e){
	...
	moveShape:function(e){
		...
		var x=((e.pageX-$(obj.image.node).offset().left)>0)?1:-1;
		var y=((e.pageY-$(obj.image.node).offset().top)>0)?1:-1;
