                     ...
                     if (self._points) {
						 ...
						 // GENERATE TILE NODE
							...
							node = new Node({pos:{
									x: cur.x,
									y: cur.y
								},shape:self._obj,vd:{_cont:$(".vd-container")},offsets:{offsetTop: self._offTop, offsetLeft: self._offLeft}});
                     } else {
                         self._points = [cur];
                         self._obj = self._paper.path(makePathStr(self._points));
						...
						if (targetObj.con=="path"){
							...
							_.each(targetObj.points, function(p){
							 ...
							 var node = new Node({pos:{
									x: p.x,
									y: p.y
								},shape:targetObj,vd:{_cont:$(".vd-container")},offsets:{offsetTop: self._offTop, offsetLeft: self._offLeft}});
