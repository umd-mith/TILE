...
$(this).removeClass("axe_node_selected");
		...
		exportShapes: function(){
			...
			_.each(this._activeShapes, function (o) {
				...
				thisShape = {"id": id, "type": type, "scale": (o.scale||self._scale), "posInfo":posInfo};		
		...
		scale: function(x) {
			...
			$(self._paper.node).width(self._cont.width()*self._scale);
			$(self._paper.node).height(self._cont.height()*self._scale);
