...
$(this).removeClass("axe_node_selected");
		...
		exportShapes: function(){
			...
			_.each(this._activeShapes, function (o) {
				...
				thisShape = {"id": id, "type": type, "scale": (o._scale||self._scale),"color":o.color,"posInfo":posInfo};		
		...
		exportShapes: function(){
			...
			_.each(this._activeShapes, function (o) {
				...
				thisShape = {"id": id, "type": type, "scale": o.scale, "color":o.color,"posInfo":posInfo};		
				JSONoutput.push(thisShape);
				});
