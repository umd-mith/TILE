	...
	setHTML:function(){
		...
		exportShapes: function(){
			...
			_.each(this._activeShapes, function (o) {
				...
				console.log(self._scale+'  '+o._scale+"  vectordrwer._scale/shape._scale:  "+p);
				if (type == 'rect') {
                    var as = o.attr(["x", "y", "width", "height"]);
					console.log("rect properties: "+as);
				...
				if(posInfo){
					console.log("posInfo of shape: ");
					for(bb in posInfo){
						console.log(bb+"  "+posInfo[bb]);
					}
				}
