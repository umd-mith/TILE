(function ($, R, _) {
	...
	var TILEDRAW=VectorDrawer.extend({
		init:function(args){
			this.$super(args.initDrawMode, args.initScale, args.initObjs, args.overElm, args.auxClass);
			
			this._loc=(args.auxContainer)?args.auxContainer:$("body");
			...
			self._over = {
	             elm: $(overElm),
	             offset: {left:0,top:0},
	             origWidth: args.startsize[0]*initScale,
	             origHeight: args.startsize[1]*initScale,
