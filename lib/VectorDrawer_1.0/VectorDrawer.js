...
(function ($, R, _) {
	...
	setHTML:function(){
		...
		_getCanvasXY: function (e) {
			var self = this;
			console.log("getxy: "+e.clientX+" minus "+self._canvas.off.left+" scrollTop: "+self._over.elm.scrollTop());
			return {
				
				x: (e.clientX-self._over.offset.left)+parseFloat(self._cont.parent().scrollLeft())+parseFloat($('body').scrollLeft()),
				y: ((e.clientY-self._over.offset.top)+parseFloat(self._cont.parent().scrollTop())+parseFloat($("body").scrollTop()))
			};
		},
