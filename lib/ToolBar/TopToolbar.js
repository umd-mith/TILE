...
var TILETopToolBar=TopToolBar.extend({
	init:function(args){
		...
		this.newImageB.bind("click",{obj:this},this.setNewImage);
		
		this.importB=$("#import");
		this.importB.bind("click",{obj:this},this.importSettings);
		this.saveB=$("#save");
		this.saveB.bind("click",{obj:this},this.saveSettings);
		this.helpB=$("#help");
		this.helpB.click(function(e){
			$(this).trigger("showHelp");
		});
	},
	setNewImage:function(e){
