...
var TileTabBar=TabBar.extend({
	...
	tagDeletedHandle:function(e,i,tag){
		var obj=e.data.obj;
		if(obj.imageLoaded&&(obj.docData[obj.currPage])){
			
			obj.docData[obj.currPage].tags=jQuery.each(obj.docData[obj.currPage].tags,function(i,el){
				return (el.htmlindex!=tag.htmlindex);
			});
