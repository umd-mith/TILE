...
var TILEShapeToolBar=SideToolBar.extend({
	init:function(args){
		...
		$("body").bind("setCoordRegion",{obj:this},this.activateShapeBar);
	...
	activateShapeBar:function(e){
		if(e){
			var obj=e.data.obj;
		//	$("body").unbind("setCoordRegion",obj.activateShapeBar);
		//	$("body").bind("coordDataSent",{obj:obj},obj.deactivateShapeBar);
			obj.rect.removeClass("inactive");
			obj.poly.removeClass("inactive");
			obj.elli.removeClass("inactive");
			//obj.delShape.removeClass("inactive");
		} else {
		//	$("body").unbind("setCoordRegion",this.activateShapeBar);
		//	$("body").bind("coordDataSent",{obj:this},this.deactivateShapeBar);
			this.rect.removeClass("inactive");
			this.poly.removeClass("inactive");
			this.elli.removeClass("inactive");
			//this.delShape.removeClass("inactive");
		}
	},
	deactivateShapeBar:function(e){
		if(e){
			var obj=e.data.obj;
			//attach listener for imageLoaded
		//	$("body").unbind("coordDataSent",obj.deactivateShapeBar);
		//	$("body").bind("setCoordRegion",{obj:obj},obj.activateShapeBar);
			obj.rect.addClass("inactive");
			obj.poly.addClass("inactive");
			obj.elli.addClass("inactive");
			//obj.delShape.addClass("inactive");
		} else {
			//attach listener for imageLoaded
		//	$("body").unbind("coordDataSent",this.deactivateShapeBar);
		//	$("body").bind("setCoordRegion",{obj:this},this.activateShapeBar);
			this.rect.addClass("inactive");
			this.poly.addClass("inactive");
			this.elli.addClass("inactive");
			//this.delShape.addClass("inactive");
		}
	},
	shapeSet:function(e){
		var obj=e.data.obj;
		...
		$("body").unbind("coordDataSent",obj.shapeSet);
	},
	shapeUnSet:function(e){
		...
		$("body").bind("coordDataSent",{obj:obj},obj.shapeSet);
	}
});
