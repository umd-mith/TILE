...
var TILEShapeToolBar=SideToolBar.extend({
	...
	deactivateShapeBar:function(e){
		if(e){
			...
			if(obj.rect.hasClass("active")){obj.rect.removeClass("active");obj.shapeType="r";}
			obj.poly.addClass("inactive");
			if(obj.poly.hasClass("active")){obj.poly.removeClass("active");obj.shapeType="p";}
			obj.elli.addClass("inactive");
			if(obj.elli.hasClass("active")){obj.elli.removeClass("active");obj.shapeType="e";}
			$("#colorSelector2").addClass("inactive");
		} else {
			//attach listener for imageLoaded
			this.rect.addClass("inactive");
			if(this.rect.hasClass("active")){this.rect.removeClass("active");this.shapeType="r";}
			this.poly.addClass("inactive");
			if(this.poly.hasClass("active")){this.poly.removeClass("active");this.shapeType="p";}
			this.elli.addClass("inactive");
			if(this.elli.hasClass("active")){this.elli.removeClass("active");this.shapeType="e";}
			$("#colorSelector2").addClass("inactive");
		}
	},
	shapeSet:function(e){
