	...
	function changeINIT_ATTRColor(e,hex){
     ...
     jQuery.extend(VectorDrawer.prototype, {
		...
		loadMasterObjList:function(list){
			...
			for(l in list){
				if(!this._manifest[list[l].uri]) this._manifest[list[l].uri]=[];
				//alert("shapes length: "+list[l].uri+":  "+list[l].shapes.length);
				for(sh in list[l].shapes){
					var o=list[l].shapes[sh];
					var args=null;
					
					switch(o.con){
						case 'rect':
							args=[o.x,o.y,o.width,o.height];
							break;
						case 'ellipse':
							args=[o.cx,o.cy,o.rx,o.ry];
							break;
						case 'poly':
							args=[];
							break;
					...
					$.extend(o,{
						cur:null,
						args:args,
						shapeChangeCall:"shapeCoordUpdate"+o.id,
						anchor:false,
						_display:false,
						deactivate:function(){
							this.cur.hide();
					...
					this._manifest[list[l].uri].push(o);
				}
