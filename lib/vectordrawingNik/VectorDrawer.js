		...
		//@w,h: null - canvas set to origWidth & origHeight, int - canvas set to these sizes
         _buildCanvas: function(w,h) {
			...
			//using two additional variables: w, h
			 ...
			 if((w==null)||(h==null)){alert('made canvas');
         		self._paper = R(self._over.offset.left, self._over.offset.top,self._over.origWidth,self._over.origHeight);alert('made canvas');
