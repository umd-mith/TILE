	...
	**/
	...
	TILE_ENGINE.prototype={
		...
		setUp:function(){
			...
			_transcriptBar=new TileToolBar({loc:"tile_toolbar"});
		...
		_parseOutJSON:function(){
			...
			//send to toolbar
			_transcriptBar.setChoices(pluginControl.toolSet);
	...
	TileToolBar=function(args){
		...
		// }
			...
			var html='<div class="menuitem"><ul><li><a id="load_tags" href="" class="button" title="Load a saved session">Load</a></li></ul></div>'+
			'<div class="menuitem"><ul><li><a id="save_tags" href="" class="button" title="Save the current session">Save</a></li></ul></div>'+
			'<div class="menuitem"><ul><li><a id="exp_xml" href="" class="button" title="Export the current session back into the source XML file">Export XML</a></li></ul></div>'+
