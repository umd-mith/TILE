	...
	**/
	...
	$.extend(FloatingDiv.prototype, {
		...
		setInputObject:function(o,refs){
			...
			if(__v) console.log("refs for "+o.id+"  "+refs);
			if(refs){
				var sh=null;
				for(var r in refs){
			...
			if((obj1!=null)&&(obj2!=null)){
				...
				if(/http\:|\.[jgpt]*/i.test(obj1.jsonName)){
					...
					if($.inArray(obj2.id,self.linkArray[url][obj1.type][found][obj2.type])){
						...
						self.refArray[obj1.id].push({"id":obj2.id,"type":obj2.type,"jsonName":obj2.jsonName});
					}					
						if(__v) {
				...
				if(/http\:|\.[jgpt]*/i.test(obj2.jsonName)){
					...
					if($.inArray(obj2.id,self.linkArray[url][obj2.type][found][obj1.type])){
						...
						self.refArray[obj2.id].push({"id":obj1.id,"type":obj1.type,"jsonName":obj1.jsonName});
					}					
					if(__v) {
					...
					if(!(self.linkArray[obj2.type][p][obj1.type])){
						self.linkArray[obj2.type][p][obj1.type]=[];
					}
