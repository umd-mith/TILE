...
var SVGResize=Resize.extend({
	...
	deactivate:function(e){
		if(e&&(e.type=="startDrag")){
			...
			//deactivates 
			this.listenEl.unbind("mousedown",this.startResize);
			this.listenEl.unbind("mousemove",this.resize);
			this.listenEl.unbind("mousemove",this.trackMouse);
			this.listenEl.unbind("mouseup",this.stopResize);
		}
	},
	activate:function(e){
