	...
	RaphaelImage.prototype={
		...
		_restart:function(json,url){
			...
			if(self.drawTool){
				...
				if(__v) console.log('image tagger elements: '+JSON.stringify(self.manifest));
				if(__v) console.log('json elements in  imagetagger: '+JSON.stringify(json));
				for(var j in json){
