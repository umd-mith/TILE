...
var TS={
	...
	start:function(engine){
		...
		engine.insertModeButtons('<div class="menuitem"><ul><li><a id="getHLite" class="btnIconLarge getHLite" title="Activate Highlight Mode">Activate Highlight Mode</a></li></ul></div>','log','Image Annotation');
