...
var ImportDialog=function(args){
	...
	// args same as Dialog()
		...
		// '<input id="swineburne1" class="form_Choice" type="radio"  name="importchoice" /> Swinburne Cleopatra<br/>'+
		'<input id="importDataFormSubmitMulti" title="Submit the Import Path." type="submit" class="button" name="submit" value="Submit" />'+
