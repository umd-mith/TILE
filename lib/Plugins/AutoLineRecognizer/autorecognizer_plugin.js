	...
	**/
	var TileOCR=function(args){
		// Constructor
			...
			self.logHTML="<div id=\"autoreclog\" class=\"az tool\"><div id=\"autorecarea\" class=\"az inner autolinerecognizer\"><div class=\"autorec_toolbar\"><div class=\"toolbar\">Auto Line Recognizer<div class=\"menuitem\">"+
			...
			"<a id=\"autorec_recognize\" class=\"button\">Go</a></div></div></div>";
	...
	start:function(engine){
		...
		if(!self.__AR__){
			...
			var onActive=function(){
				self.__AR__._restart();
			};
			
			engine.insertMode('Auto Line Recognizer',onActive);
