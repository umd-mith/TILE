	...
	**/
	var TileOCR=function(args){
		// Constructor
			...
			self.logHTML="<div class=\"autorec_toolbar\"><div class=\"toolbar\">Auto Line Recognizer<div class=\"menuitem\">"+
			...
			"<a id=\"autorec_recognize\" class=\"button\">Go</a></div>";
...
var AR={
	...
	start:function(engine){
		...
		if(!self.__AR__){
			...
			// sidbar - left side
			engine.insertModeHTML(this.__AR__.logHTML,'log','Auto Line Recognizer');
