		...
		**/
		...
		_recognize:function(){
			...
			//	self.regionList[self.curRegion].images.push($("#srcImageForCanvas").attr('src'));
				...
				var alphaTop=_REG.top-parseInt($(".az.main").css("top"),10);
		...
		**/
		var RegionBox=function(args){
			// Constructor
				...
				if(__v) console.log("toolbar height ar: "+$("#azcontentarea > .az.inner.autoRec > .toolbar").height());
				self.DOM.css({"left":0,"top":(p.top+$("#azcontentarea > .az.inner.autoRec > .toolbar").height())});
