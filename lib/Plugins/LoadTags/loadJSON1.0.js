...
(function($){
	...
	var LoadTags=function(args){
		// Constructor: (Same as Dialog)  {loc: {String} id for where to put DOM, html: {String} JSON string representing html for this Dialog}
			...
			'<input id="faust" type="radio" class="chooseFile" name="groupChoice" value="http://localhost:8888/tile/TILE.git/importWidgets/importExternalFiles.php?file=faust.json">Faust Online Data</input>'+
