...
(function($){
	...
	var LoadTags=function(args){
		// Constructor: (Same as Dialog)  {loc: {String} id for where to put DOM, html: {String} JSON string representing html for this Dialog}
			...
			'</div></div><div class="body"><div class="option"><h3>Load Session From File (See dropdown for supported Filetypes - .json supported by default)</h3>'+
	...
	LoadTags.prototype={
		...
		submitFile:function(e){
			...
			alert(url);
			return;
			var file=$("#loadTagsForm > #importTagsFilename").val();
