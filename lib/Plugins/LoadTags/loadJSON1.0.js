...
(function($){
	...
	var LoadTags=function(args){
		// Constructor: (Same as Dialog)  {loc: {String} id for where to put DOM, html: {String} JSON string representing html for this Dialog}
			...
			'</form>'+
			'<form id="loadURLForm" action="" method="GET"><label>Input from URL:</label><input id="importURL" type="text" name="importurl"/><br/><input id="submitURL" class="button" type="submit" value="Load URL"/></form>'+
