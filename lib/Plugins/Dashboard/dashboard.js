...
var Dashboard={
	start:function(engine){
		...
		// create html
		self.html='<div class="dash_header"><a id="backToViews">Home</a></div><div id="dashboard_body" class="body"><div class="dashboard_main"><div id="jsonView"></div></div><div class="dashboard_sidebar"><h3>Modes:</h3><div id="modeChoose"></div></div></div>';
		// main page that users begin with
		self.startHTML='<div id="startPageDashboard" class="dashboard_list"><h3><a id="seeJSON">JSON View</a></h3><br/><p>View the Core Data as a list.</p></div>';
		...
		// attach beginning page
		$(self.startHTML).insertBefore($("#jsonView"));
	...
	displayOnDashboardHandle:function(e,o){
		...
		if($("#dashboard_sidebar > #"+o.mode).length){
			$("#dashboard_sidebar > #"+o.mode).empty().append(o.html);
		} else {
			// create new module section
			var section='<div id="'+o.mode+'">'+o.mode.html+'</div>';
			$("#dashboard_sidebar").append(section);
		}
