...
var LB={
	...
	start:function(engine){
		...
		var html='<div class="toolbar" id="addLabelToolbar"><div class="menuitem pluginTitle">Labels</div><div class="menuitem"><ul><li><input id="addLabelText" class="" type="text" value="" /></li></ul></div><div class="menuitem"><ul><li><a id="clearTextArea" class="button">Clear</a></li></ul></div></div><div id="labelList" class="az"></div>';
