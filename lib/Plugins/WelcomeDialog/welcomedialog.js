...
var WelcomeDialog=function(args){
	...
	// args same as Dialog()
		...
		self.loc=args.loc;
		//set up JSON html
		var html='<div id="light" class="white_content"><div id="welcomeDialog" class="dialog"><div class="header"><h2 class="title">Welcome</h2><div class="clear"></div>'+
		'</div><div class="body"><div class="description"><h3>Introduction to TILE</h3>'+
		'<p>The Text-Image Linking Environment (TILE) is a tool for creating and editing image-based electronic editions and digital archives of humanities texts.</p>'+
		'<p>This initial release of TILE features:'+ 
