...
<div id="tag_<?php echo $ID; ?>" class="tag">
	...
	<ul id="tagAtr_<?php echo $ID; ?>" class="tagattrb"><a id="tagChoice_<?php echo $ID; ?>" class="tagChoice"><select id="tagChoiceList_<?php echo $ID; ?>" class="tagChoiceList"></select></a></ul>
</div>
<?php } ?>