...
var TagRegion=Region.extend({
	init:function(args){
		...
		$("body").bind("shapeChangeCall_"+this.shapeId,{obj:this},this.captureShapeData);
		
		this.updateCoordText(this.shapeId);
	},
	...
	listenOff:function(){
		...
		this.DOM.trigger("shapeDisplayChange",["d",this.shapeId]);
		$('body').unbind("shapeChangeCall_"+this.shapeId,this.captureShapeData);
	},
	listenOn:function(){
		this.DOM.trigger("shapeDisplayChange",["a",this.shapeId]);
		$('body').bind("shapeChangeCall_"+this.shapeId,{obj:this},this.captureShapeData);
	},
	showcase:function(){
		// this.shape.activate();
	...
	anchorOn:function(){
		...
		this.DOM.trigger("shapeDisplayChange",["sa",this.shapeId]);
	},
	anchorOff:function(){
		this.anchor=false;
		this.DOM.trigger("shapeDisplayChange",["ra",this.shapeId]);
