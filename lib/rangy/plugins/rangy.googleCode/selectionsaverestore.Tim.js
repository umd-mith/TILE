rangy.createModule("WrappedSelection", function(api, module) {
	...
	*/
    function insertRangeBoundaryMarker(range, atStart) {	
		...
		markerEl.id = markerId;
		markerEl.className = "fnstar-left";
		// the flag tells us if we own the annotation or not
		// and is set up by comparing userID returned in JSON
		// with userID from cookie from login
		if (atStart) {
			markerEl.src = "http://brie.dlib.indiana.edu:8080/newton-tdb/annotationTool/clientSide/icons/comment.left.personal.png";
		} else {
			markerEl.src = "http://brie.dlib.indiana.edu:8080/newton-tdb/annotationTool/clientSide/icons/comment.right.personal.png";
		}
	/*
		markerEl = doc.createElement("span");
		markerEl.id = markerId;
