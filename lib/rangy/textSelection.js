...
var TS={
	...
	start:function(e,json,layout){
		...
		// TILE interface
		// append html
		$("<div class=\"menuitem\"><ul><li><a class=\"button\" value=\"Highlight\" id=\"getHLite\" title=\"Highlight a section of text\" class=\"button\">Highlight a section of text</a></li></ul></div>").insertBefore($("#transcript_toolbar > div#ddown"));
		// getText button
